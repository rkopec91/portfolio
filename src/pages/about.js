    ...
    <section className="about-page">
      <div className="section-center about-center">
        ...
        <article className="about-text">
          ...
          <p>
            I completed my Bachelor’s of Science in Mechanical Engineering and received a minor in electrical engineering at Drexel University and I recently graduated from Georgia Institute of Technology with my Master’s in Computer Science with a specialization in machine learning/computer vision.  I am very interested in machine learning, deep learning, artificial intelligence, computer vision, natural language processing, web development, and software engineering.
          </p>
          <p>
            As a student at Georgia Tech, Drexel University, and Burlington County College I had the chance to explore many different projects and classes that gave me a wide range of experience.  I took controls classes, math classes, thermodynamic classes, fluids classes, Computer Vision classes, Machine Learning classes and electrical engineering classes.  I enjoy writing code and solving difficult and interesting problems.  In my free time I develop a wide range of projects such as android applications, video games, artificial intelligence/machine learning/deep learning models, and anything that will challenge my software development skills.  One of my favorite languages to develop in is Python, however, I am not limited to just that language.  For example, I have experience in C++, Javascript, CSS, HTML, and React.  My goal is to learn something new every day.
          </p>
          <p>
          ...
          <p>
            When I am not coding, I like to spend my time outside.  Some of my interests are playing hockey, tennis, hiking, biking, camping, skiing/snowboarding, kayaking and working out.  I love to stay active when I can. 
          </p>
